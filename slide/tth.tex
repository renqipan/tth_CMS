...
\begin{figure}[H]
\centering
\subfloat[compare the ROC curves between with and without btag]{\includegraphics[width=0.5\textwidth]{./figures/ROC_Curve_btag.png}} 
\subfloat[ compare the ROC curves between 6 jets and 10 jets]{\includegraphics[width=0.5\textwidth]{./figures/ROC_Curve_jets.png}}
\end{figure}
\end{frame}
...
\begin{figure}[H]
\centering
\subfloat[leptonic channel]{\includegraphics[width=0.5\textwidth]{./figures/lep_BDT.png}} 
\subfloat[hadronic channel]{\includegraphics[width=0.5\textwidth]{./figures/had_BDT.png}}
\end{figure}
\end{frame}
