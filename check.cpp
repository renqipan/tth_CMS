...
tree->GetEntry(200);
for(int ijet=1;ijet<11;ijet++){	
	if(bjetPt_1==jet[ijet-1][0] && bjetEta_1==jet[ijet-1][1] && bjetPhi_1==jet[ijet-1][2] && bjetE_1==jet[ijet-1][3])
		{cout<<"bjet_1 is the "<<ijet<<"th jet"<<endl;
			b1=true;
		}

	if(jet[ijet-1][0]==bjetPt_2 && jet[ijet-1][1]==bjetEta_2 && jet[ijet-1][2]==bjetPhi_2 && jet[ijet-1][3]==bjetE_2)
