void roc_plot_compare(){
	string fileNames[2]={"hzzhad_output.root","hzzlep_output.root"};
	string dir_sig[]={"dataset_hzz_had/Method_BDT/BDT/MVA_BDT_S",
	"dataset_hzz_lep/Method_BDT/BDT/MVA_BDT_S"};
	string dir_bkg[]={"dataset_hzz_had/Method_BDT/BDT/MVA_BDT_B",
	"dataset_hzz_lep/Method_BDT/BDT/MVA_BDT_B"};
	TMultiGraph *mg = new TMultiGraph();
	auto leg=new TLegend(.7,.7,.9,.9,"Channel");
    string legend[2]={"hadronic","leptonic"};
	...
	gPad->Print("ROC_channel_points.png");
