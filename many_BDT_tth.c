...
TString outfileName( "10jets_many_output.root");
...
TMVA::DataLoader loader("dataset_many");
...
loader.AddVariable("diPhoEta",'F');
	...
	//loader.AddVariable("helcosthetaZ1_1",'F');
	...
	//loader.AddVariable("costhetastar_2",'F');
...
c1->Draw();
gPad->Print("many_Significance.png");
